...
- [ ] **Phase 10: Hardening & Launch** - Security headers, rate limiting, final audit
...
Plans:
- [ ] 02-01: Email/password signup and login
- [ ] 02-02: Google OAuth integration
- [ ] 02-03: Session security (token expiration, refresh tokens)

### Phase 3: Database & RLS
**Goal**: Establish row-level security and input sanitization before data flows
**Depends on**: Phase 2
**Research**: Likely (RLS policy patterns, sanitization edge cases)
**Research topics**: Supabase RLS best practices, input sanitization beyond Zod, SQL injection vectors
**Requirements**: SEC-05, SEC-06
**Plans**: TBD

Plans:
- [ ] 03-01: RLS policies for all tables with tests
- [ ] 03-02: Input sanitization layer (XSS, SQL injection prevention)
...
**Goal**: Security headers, rate limiting, landing page, weekly review
**Depends on**: Phase 9
**Research**: Unlikely (security header configs well-documented)
**Requirements**: LAND-01, REV-01, REV-02, REV-03, SEC-07, SEC-08, SEC-10, SEC-13, SEC-14
**Plans**: TBD

Plans:
- [ ] 10-01: Landing page
- [ ] 10-02: Weekly review feature
- [ ] 10-03: Security hardening (headers, CSRF, rate limiting)
